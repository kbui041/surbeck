          ...
          <div className="grid cols-2" style={{ gap: 40 }}>
            <div className="panel">
              ...
              <ul className="res">
                ...
                <li><span className="rk">+</span><div><p>Total control by Dr. Surbeck. Requested changes from either patient or dental team can be implemented as soon as the next appointment. This shortens treatment length and any interdisciplinary dental work needed.</p></div></li>
